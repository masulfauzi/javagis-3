                    ...
                    <div class="col-lg-10 offset-lg-2">
                        <div class="row">
                            <div class='col-lg-2'><p>Nama Kups</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $kups->nama_kups }}</p></div>
									<div class='col-lg-2'><p>Kps</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $kups->kps->nama_kps }}</p></div>
									
									<div class='col-lg-2'><p>Wilayah</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $kups->desa->nama_desa }} - {{ $kups->desa->kecamatan->nama_kecamatan }} - {{ $kups->desa->kecamatan->kabupaten->nama_kabupaten }} - {{ $kups->desa->kecamatan->kabupaten->provinsi->nama_provinsi }} - {{ $kups->desa->kecamatan->kabupaten->provinsi->seksiWilayah->nama_seksi_wilayah }} - {{ $kups->desa->kecamatan->kabupaten->provinsi->seksiWilayah->balaiPskl->nama_balai_pskl }}</p></div>
                                                    ...
                                                    <form class="form form-horizontal">
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-10 form-group">
                                                                    <div class="form-control">{{ $kups->bentukKups->bentuk_kups }}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                ...
                                                                <div class="col-md-10 form-group">
                                                                    <div class="form-control">{{ $kups->kelasKups->nama_kelas_kups }}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label for="contact-info-horizontal">Skema PS</label>
                                                                </div>
                                                                <div class="col-md-10 form-group">
                                                                    <div class="form-control">{{ $kups->skemaPs->nama_skema }}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label for="contact-info-horizontal">Dibentuk Tahun</label>
                                                                </div>
                                                                <div class="col-md-10 form-group">
                                                                    <div class="form-control">{{ $kups->tahun_dibentuk }}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
