    ...
    <div class="page-title">
        <div class="row mb-2">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <a href="{{ route('desa.index') }}" class="btn btn-sm icon icon-left btn-outline-secondary"><i class="fa fa-arrow-left"></i> Kembali </a>
            </div>
                    ...
                    <div class="col-lg-10 offset-lg-2">
                        <div class="row">
                            <div class='col-lg-2'><p>Kecamatan</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $desa->kecamatan->id }}</p></div>
									...
									<div class='col-lg-2'><p>Kode Desa</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $desa->kode_desa }}</p></div>
