    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('skemaps.index') }}" method="get">
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('skemaps.show','', $item->id) !!}
										{!! button('skemaps.edit', $title, $item->id) !!}
                                        {!! button('skemaps.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
